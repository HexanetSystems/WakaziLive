                 ...
                 <table class="sa-datatables-init text-nowrap" data-order="[[ 1, &quot;desc&quot; ]]" data-sa-search-input="#table-search">
                    ...
                    <tbody>
                       <tr>
                          ...
                          <td><a href="app-order.html" class="text-reset">#3201</a></td>
                          <td>June 26, 2021</td>
                          <td><a href="app-customer.html" class="text-reset">Jessica Moore</a></td>
                          <td>
                          ...
                          <td>3 items</td>
                          <td>
                             <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer">200</span><span class="sa-price__decimal">.00</span></div>
                          </td>
                          <td>
                             <div class="dropdown">
