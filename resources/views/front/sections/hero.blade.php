<div class="main-slider-wrapper">
    <div class="slider-inner">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="slider-thumbs">
                    ...
                    <div class="slick-slide">
                        <div class="banner-media" data-name="Leggings">
                            <div class="img-preview">
                    ...
                    <div class="slick-slide">
                        <div class="banner-media" data-name="Dress">
                            <div class="img-preview">
        ...
        <div class="bottom-content align-items-end wow fadeInUp" data-wow-delay="1.0s">
            ...
            <div>
                <span class="sub-title">Wakazi Collection</span>
        ...
        <a class="animation-btn popup-youtube" href="https://www.youtube.com/watch?v=Xs2hAWuPmSg">
            <div class="text-row word-rotate-box c-black">
                <span class="word-rotate"> Take Our Virtual Tour </span>
