                ...
                <div class="col-lg-6 col-md-12 m-b30">
                    <div class="about-thumb wow fadeInUp  position-relative" data-wow-delay="0.2s">
                        <div class="dz-media h-100">
                            <img src="{{asset('theme/images/women.png')}}" alt="">
                        </div>
                        <a href="shop-list.html" class="btn btn-outline-secondary btn-light btn-xl">Woman collection</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 align-self-center">
                    <div class="about-content">
                        <div class="section-head style-1 wow fadeInUp" data-wow-delay="0.4s">
                            <h3 class="title ">Renaissance fuses Avant-Garde</h3>
                        ...
                        <a class="service-btn-2 wow fadeInUp" data-wow-delay="0.6s" href="about-us.html" >
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop-card style-6 wow fadeInUp" data-wow-delay="0.8s">
                                    <div class="dz-media">
                                        <img src="{{asset('theme/images/shop/product/medium/1.png')}}" alt="image">
                                    </div>
                                    <div class="dz-content">
                                        <a href="shop-list.html" class="btn btn-outline-secondary btn-light btn-md">Child Fashion</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop-card style-6 wow fadeInUp" data-wow-delay="1.0s">
                                    <div class="dz-media">
                                        <img src="{{asset('theme/images/shop/product/medium/2.png')}}" alt="image">
                                    </div>
                                    <div class="dz-content">
                                        <a href="shop-list.html" class="btn btn-outline-secondary btn-light btn-md">Man collection</a>
                                    </div>
