            ...
            <div class="clearfix">
                <ul id="masonry" class="row g-xl-4 g-3">
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Tops wow fadeInUp" data-wow-delay="0.6s">
                        <div class="shop-card">
                            <div class="dz-media">
                                <img src="{{asset('theme/images/shop/product/pexels-ekrulila-3246665.jpg')}}" alt="image">
                                <div class="shop-meta">
                                    <a href="javascript:void(0);" class="btn btn-secondary btn-md btn-rounded" data-bs-toggle="modal" data-bs-target="#sssexampleModal">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 1</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Dresses Jacket wow fadeInUp" data-wow-delay="0.8s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 2</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Dresses wow fadeInUp" data-wow-delay="1.0s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 3</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Tops Jacket wow fadeInUp" data-wow-delay="1.2s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 4</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Dresses wow fadeInUp" data-wow-delay="0.2s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 5</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Outerwear wow fadeInUp" data-wow-delay="0.4s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 6</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Dresses wow fadeInUp" data-wow-delay="0.6s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">Product 7</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
                    ...
                    <li class="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Tops wow fadeInUp" data-wow-delay="2.0s">
                        <div class="shop-card">
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="shop-list.html">WProduct 8</a></h5>
                                <h5 class="price">kes 8500</h5>
                            </div>
                            <div class="product-tag">
                                <span class="badge ">Custom Tag</span>
