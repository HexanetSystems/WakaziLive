				...
				<div class="container-fluid clearfix d-lg-flex d-block">
					...
					<div class="header-nav w3menu navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
						<div class="logo-header logo-dark">
							<a href="{{url('/')}}"><img src="{{asset('theme/images/logo.svg')}}" alt=""></a>
						</div>
						<ul class="nav navbar-nav">
							<li class="has-mega-menu sub-menu-down auto-width menu-left">
								...
								<div class="mega-menu ">
									<ul class="demo-menu mb-0">
										<li>
											<a href="{{url('/')}}">
												<img src="{{asset('theme/images/demo/demo-1.png')}}" alt="/">
												<span class="menu-title">01 Home Page</span>
											</a>
										</li>
										<li>
											<a href="index-2.html">
												<img src="{{asset('theme/images/demo/demo-2.png')}}" alt="/">
												<span class="menu-title">02 Home Page</span>
											</a>
										</li>
										<li>
											<a href="index-3.html">
												<img src="{{asset('theme/images/demo/demo-3.png')}}" alt="/">
							...
							<li class="has-mega-menu sub-menu-down">
								...
								<div class="mega-menu shop-menu">
									<ul>
										<li class="side-left">
											<ul>
												<li><a href="javascript:void(0);" class="menu-title">Shop Structure</a>
													<ul>
												...
												<li><a href="javascript:void(0);" class="menu-title">Product Structure</a>
													<ul>
												...
												<li><a href="javascript:void(0);" class="menu-title">Shop Pages</a>
													<ul>
										...
										<li class="side-right">
											<div class="adv-media">
												<img src="{{asset('theme/images/adv-1.png')}}" alt="/">
											</div>
										</li>
									</ul>
								</div>
												...
												<ul>
													<li>
														...
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">Cozy Knit Cardigan Sweater</a></h6>
															<span class="time">July 23, 2023</span>
														</div>
													</li>
													<li>
														<div class="dz-media">
															<img src="{{asset('theme/images/shop/product/small/2.png')}}" alt="">
														</div>
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">Sophisticated Swagger Suit</a></h6>
															<span class="time">July 23, 2023</span>
														</div>
													</li>
													<li>
														<div class="dz-media">
															<img src="{{asset('theme/images/shop/product/small/3.png')}}" alt="">
														</div>
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">Athletic Mesh Sports Leggings</a></h6>
															<span class="time">July 23, 2023</span>
														</div>
													</li>
													<li>
														<div class="dz-media">
															<img src="{{asset('theme/images/shop/product/small/4.png')}}" alt="">
														</div>
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">Satin Wrap Party Blouse</a></h6>
															<span class="time">July 23, 2023</span>
														</div>
													</li>
												</ul>
											...
											<ul class="portfolio-nav-link">
												<li>
													<a href="portfolio-tiles.html">
														<img src="{{asset('theme/images/portfolio/icons/portfolio-tiles.svg')}}" alt="/">
														<span>Portfolio Tiles</span>
													</a>
												</li>
												<li>
													<a href="collage-style-1.html">
														<img src="{{asset('theme/images/portfolio/icons/collage-style-1.svg')}}" alt="/">
														<span>Collage Style 1</span>
													</a>
												</li>
												<li>
													<a href="collage-style-2.html">
														<img src="{{asset('theme/images/portfolio/icons/collage-style-2.svg')}}" alt="/">
														<span>Collage Style 2</span>
													</a>
												</li>
												<li>
													<a href="masonry-grid.html">
														<img src="{{asset('theme/images/portfolio/icons/masonry-grid.svg')}}" alt="/">
														<span>Masonry Grid</span>
													</a>
												</li>
												<li>
													<a href="cobble-style-1.html">
														<img src="{{asset('theme/images/portfolio/icons/cobble-style-1.svg')}}" alt="/">
														<span>Cobble Style 1</span>
													</a>
												</li>
												<li>
													<a href="cobble-style-2.html">
														<img src="{{asset('theme/images/portfolio/icons/cobble-style-2.svg')}}" alt="/">
														<span>Cobble Style 2</span>
													</a>
												</li>
												<li>
													<a href="portfolio-thumbs-slider.html">
														<img src="{{asset('theme/images/portfolio/icons/portfolio-thumbs-slider.svg')}}" alt="/">
														<span>Portfolio Thumbs Slider</span>
													</a>
												</li>
												<li>
													<a href="portfolio-film-strip.html">
														<img src="{{asset('theme/images/portfolio/icons/portfolio-film-strip.svg')}}" alt="/">
														<span>Portfolio Film Strip</span>
													</a>
												</li>
												<li>
													<a href="carousel-showcase.html">
														<img src="{{asset('theme/images/portfolio/icons/carousel-showcase.svg')}}" alt="/">
														<span>Carousel Showcase</span>
													</a>
												</li>
												<li>
													<a href="portfolio-split-slider.html">
														<img src="{{asset('theme/images/portfolio/icons/portfolio-split-slider.svg')}}" alt="/">
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="w3menulink"><a href="w3menu.html">Menu Styles</a></li>
											</ul>
										</li>
										<li>
										...
										<li>
											<a href="javascript:void(0);" class="menu-title">Dashboard</a>
											<ul>
							...
							<li class="sub-menu-down">
								<a href="javascript:void(0);"><span>My Account <div class="badge badge-sm rounded badge-animated">New</div></span><i class="fas fa-chevron-down tabindex"></i></a>
								<ul class="sub-menu">
									<li><a href="account-dashboard.html">Dashboard</a></li>
									<li><a href="account-orders.html">Orders</a></li>
									<li><a href="account-order-details.html">Orders Details</a></li>
					...
					<div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="widget widget_about me-2">
							...
							<ul class="widget-address">
								...
								<li>
									<p><span>E-mail</span> : <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="53362b323e233f36133a3d353c7d303c3e">[email&#160;protected]</a></p>
								</li>
								<li>
									<p><span>Phone</span> : (254) 723-014032</p>
								</li>
							</ul>
				...
				<div class="row fb-inner wow fadeInUp" data-wow-delay="0.1s">
					...
					<div class="col-lg-6 col-md-12 text-end">
						<div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-xl-end">
							...
							<img src="{{asset('theme/images/footer-img.png')}}" alt="">
						</div>
					</div>
				</div>
			</div>
