...
<head>
	...
	<!-- Title -->
	<title>Wakazi Works Plartform: Your one stop shop for all your handcrafted products | Wakazi</title>
			...
			<div class="container">
				<div class="row fb-inner wow fadeInUp" data-wow-delay="0.1s">
					<div class="col-lg-6 col-md-12 text-start">
						<p class="copyright-text">Copyright © <span class="current-year">{{date('Y')}}</span> <a href="https://www.wakaziworks.com/">Wakazi Works Plartform</a> . All Rights Reserved.</p>
					</div>
