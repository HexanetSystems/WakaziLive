					...
					<div class="header-nav w3menu navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
						...
						<ul class="nav navbar-nav">
							...
							<li class="has-mega-menu sub-menu-down">
								<a href="javascript:void(0);"><span>Broken Down</span><i class="fas fa-chevron-down tabindex"></i></a>
                            ...
                            <li class="has-mega-menu sub-menu-down auto-width menu-left">
								<a href="javascript:void(0);"><span>Artisan Voices</span><i class="fas fa-chevron-down tabindex" ></i></a>
							</li>

                            <li class="has-mega-menu sub-menu-down auto-width menu-left">
								<a href="javascript:void(0);"><span>County Bounty</span><i class="fas fa-chevron-down tabindex" ></i></a>
							</li>
