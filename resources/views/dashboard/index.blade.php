        ...
        <div class="row">
            ...
            <section class="col-xl-9 account-wrapper">
                <div class="account-card">
                    <div class="m-b30">
                        <p>Hello <strong class="text-black">{{Auth::User()->name}}</strong> (not <strong class="text-black">{{Auth::User()->name}}</strong>? <a href="{{ route('logout') }}" class="sa-nav__link" onclick="event.preventDefault();   document.getElementById('logout-form').submit();" class="text-underline">Log out</a>)</p>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                        <p>From your account dashboard you can view your <a href="{{route('account-orders')}}" class="text-underline">recent orders</a>, manage your <a href="{{route('account-address')}}" class="text-underline">shipping and billing addresses</a>, and <a href="{{route('account-profile')}}" class="text-underline">edit your password and account details</a>.</p>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="total-contain">
                                ...
                                <div class="total-detail">
                                    ...
                                    <h2 class="title">{{count($Pending)}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="total-contain">
                                ...
                                <div class="total-detail">
                                    <span class="text">Total Fulfiled Order</span>
                                    <h2 class="title">{{count($Complete)}}</h2>
                                </div>
                            </div>
                        </div>
