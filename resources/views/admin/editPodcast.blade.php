        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Edit New Podcast</a>
                    </li>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/edit_Podcast/{{$Podcast->id}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="title" id="list-title" type="text" class="validate" value="{{$Podcast->title}}" required>
                                    <label for="list-title">Title</label>
                                </div>
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="file" id="list-title" type="text" class="validate" value="{{$Podcast->file}}" required>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <select required name="category" class="icons" id="mydiv">
                                        <?php $CategorySelected = DB::table('categories')->where('id',$Podcast->category)->get() ?>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea required name="meta" class="materialize-textarea">{{$Podcast->meta}}</textarea>
                                ...
                                <div class="">
                                    <div class="input-field col s12">
                                        <div class="form-group">
                                            ...
                                            <img class="image-preview" style="width:auto;" src="{{$Podcast->image}}" id='img-upload'/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="image_cheat" value="{{$Podcast->image}}">
                            <div class="row">
                                <div class="input-field col s12">
