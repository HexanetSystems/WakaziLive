        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Add New Extra</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/extras/{{$id}}"><i class="fa fa-backward" aria-hidden="true"></i> All Extras</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                ...
                <form method="POST" action="{{url('/')}}/admin/add_Extra" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
