        ...
        <div class="sb2-2">
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Color" enctype="multipart/form-data">
                            {{csrf_field()}}
                                ...
                                <div class="">
                                    <div class="input-field col s12">
                                        <div class="form-group">
                                            ...
                                            <img class="image-preview" style="width:auto;" src="{{url('/')}}/uploads/colors/c6.jpg" id='img-upload'/>
                                        </div>
                                    </div>
                                </div>
                            </div>
