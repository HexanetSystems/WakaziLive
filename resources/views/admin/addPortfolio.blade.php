        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Add New Portfolio</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/portfolio"><i class="fa fa-backward" aria-hidden="true"></i> All Portfolios</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Portfolio" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <div class="file-field">
                                        ...
                                        <div class="file-path-wrapper">
                                            <input  class="file-path validate" type="text" placeholder="Upload Portfolio Main Image, Size 390 by 480">
                                        </div>
                                    </div>
                                </div>
                            </div>
