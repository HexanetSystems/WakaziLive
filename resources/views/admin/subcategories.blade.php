        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Sub Categories</a>
                    </li>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $Parent = \App\Models\Category::find($item->category_id); echo $Parent->title ?>
                            </td>
                            ...
                            <td>
                                <a href="{{url('/')}}/admin/editSubCategories/{{$item->id}}" class="sb2-2-1-edit">
                            ...
                            function archiveFunction{{$item->id}}()
                                {
                                    ...
                                    swal({
                                        ...
                                        if (willDelete) {
                                            //do the ajax stuff.
                                            $.ajax({
                                                url: "{{url('/')}}/admin/deleteSubCategoryAjax",
