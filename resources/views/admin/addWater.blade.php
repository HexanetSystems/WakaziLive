        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="page-back"><a href="{{url('/')}}/admin/resistance"><i class="fa fa-pencil" aria-hidden="true"></i> All Water Resistance Variations</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Water" enctype="multipart/form-data">
                            {{csrf_field()}}

                            {{--  --}}
                            <div class="row">
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="title" id="list-title" value="" type="text" class="validate" required>
                            ...
                            {{-- Images --}}
                            <input type="hidden" name="image_cheat" value="null">
