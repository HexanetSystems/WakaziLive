        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Podcast</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/addPodcast"><i class="fa fa-pencil" aria-hidden="true"></i> Add Podcast Post</a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                <h2>All Podcast Posts</h2>
                <center>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/')}}/admin/editPodcast/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            </td>
                            ...
                            function archiveFunction{{$item->id}}()
                                {
                                    ...
                                    swal({
                                        ...
                                        if (willDelete) {
                                            //do the ajax stuff.
                                            $.ajax({
                                                url: "{{url('/')}}/admin/deletePodcastAjax",
