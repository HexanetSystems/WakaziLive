        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> All Pending Products</a>
                    </li>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a target="new" href="{{url('/')}}/product/{{$item->slung}}"><img width="150" height="150" src="{{$item->image_one}}"></a>
                            </td>
                            <td>
                                <a target="new" class="btn btn-success" href="{{url('/')}}/product/{{$item->slung}}" class="sb2-2-1-edit">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                    View Product
                                </a>
                                <br><br>
                                <a class="btn btn-success" href="{{url('/')}}/admin/approve-product/{{$item->id}}" class="sb2-2-1-edit">
